...
class GUI:
    ...
    def __init__(self):
        ...
        self.diam_unit = Label(main, text="[mm]")
        self.diam_unit.grid(row=2, column=4)
        ...
        self.vol_unit = Label(main, text="[mL]")
        self.vol_unit.grid(row=2, column=5)
        ...
        self.rate_unit = Label(main, text="[mL/min]")
        self.rate_unit.grid(row=2, column=6)
        ...
        self.maxvol_unit = Label(main, text="[mL]")
        self.maxvol_unit.grid(row=2, column=7)

        # ---#

        self.var_pump = tk.StringVar()

        self.num_pump_label = Label(main, text="# of Pumps:    ")
        self.num_pump_label.grid(row=1, column=8)

        self.num_pump_menu = OptionMenu(main, self.var_pump, "0", "1", "2", "3")
        self.num_pump_menu.grid(row=2, column=8)
        ...
        # Go button controls
        self.go_button = Button(main, text="Play", command=lambda: self.backend.button_push())
